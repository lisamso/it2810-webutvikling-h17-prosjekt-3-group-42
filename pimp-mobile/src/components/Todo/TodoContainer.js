        ...
        <View style={styles.row_box} key={idx}>
          ...
          >
            <View style={styles.delete_container}>
              <View style={styles.todo_delete}>
                <Text style={styles.todo_delete_text}>✓</Text>
              </View>
            </View>
          </TouchableNativeFeedback>
        </View>
  ...
  render(){
    return(
      <View style={styles.box}>
        <View style={styles.box_header_turquoise}>
          <Text style={styles.turquoise}>Your Todos</Text>
        </View>
        <View style={styles.box_body_turquoise}>
          {this.allTodos()}
        </View>
        <TouchableNativeFeedback
          onPress={() => { this.toggleModal()}}>
          <View style={styles.box_button_turquoise}>
        ...
        >
          <View style={styles.box}>
            <View style={styles.box_header_turquoise}>
              <Text style={styles.turquoise}>New todo</Text>
            </View>
            <View style={styles.box_body_turquoise}>
              <TextInput
